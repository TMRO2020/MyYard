...
StatusBar.Update = function (data = {}) {
    ...
    root.innerHTML = `
        ...
        <span>Lat <b>${d.lat}</b></span>
        <span>Lng <b>${d.lng}</b></span>
        <span>X <b>${d.x}</b></span>
        <span>Y <b>${d.y}</b></span>
        <span>Zoom <b>${d.zoom}</b></span>
        <span>Snap <b>${d.snap}</b></span>
    `;
};
...
StatusBar.SetPointer = function (data = {}) {
    StatusBar.Update({
        ...
        x: StatusBar._format(data.x, 2),
        y: StatusBar._format(data.y, 2),
